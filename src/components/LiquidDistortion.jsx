...
//         angle1: { value: Math.PI / 6 },
//         angle2: { value: -Math.PI / 6 * 3 },
...
//     // Changed from PlaneBufferGeometry to PlaneGeometry
...
//   return <div ref={containerRef} className="relative flex items-center justify-center rounded-lg bg-white/5 border-5 border-white w-full h-full"></div>;
// };
