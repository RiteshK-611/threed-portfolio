...
const Skills = () => {
  return (
    <section className="c-space my-20 h-svh overflow-hidden relative">
      ...
      <BackgroundLines>
        <h2 className="text-4xl bg-clip-text text-transparent text-center bg-gradient-to-b from-neutral-600 to-white font-semibold absolute top-1/2 left-1/2 -translate-x-1/2">
